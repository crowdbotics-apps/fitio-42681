"""
Django settings for fitio_42681 project.
...
WSGI_APPLICATION = 'fitio_42681.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fitio_42681 API",
    "DESCRIPTION": "API documentation for fitio_42681 App",
    "VERSION": "v1",
}
